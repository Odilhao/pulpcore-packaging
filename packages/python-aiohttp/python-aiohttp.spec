...
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-async-timeout >= 4.0.0a3
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-asynctest = 0.13.0
...
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-charset-normalizer < 4.0
...
Requires:       %{?scl_prefix}python%{python3_pkgversion}-async-timeout >= 4.0.0a3
...
Requires:       %{?scl_prefix}python%{python3_pkgversion}-charset-normalizer < 4.0
...
%doc README.rst vendor/README.rst vendor/llhttp/README.md
%{python3_sitearch}/%{pypi_name}
%{python3_sitearch}/%{pypi_name}-%{version}-py%{python3_version}.egg-info


%changelog
* Mon Jan 15 2024 root <root@localhost> 3.8.6-1
- Update to 3.8.6
