...
Requires:       %{?scl_prefix}python%{python3_pkgversion}-cryptography >= 36.0.0
...
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-drf-spectacular = 0.21.0
...
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-whitenoise < 5.4.0
