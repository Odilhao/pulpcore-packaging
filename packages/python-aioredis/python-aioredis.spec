...
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-hiredis >= 1.0
...
Requires:       %{?scl_prefix}python%{python3_pkgversion}-hiredis >= 1.0
...
%changelog
* Tue Jan 18 2022 Odilon Sousa 2.0.1-1
- Update to 2.0.1
