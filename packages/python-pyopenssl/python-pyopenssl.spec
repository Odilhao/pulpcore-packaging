...
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-cryptography >= 3.3
...
Requires:       %{?scl_prefix}python%{python3_pkgversion}-cryptography >= 3.3
...
%changelog
* Tue Jan 18 2022 Odilon Sousa - 21.0.0-1
- Initial package.
